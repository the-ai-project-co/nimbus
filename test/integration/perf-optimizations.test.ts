...
import { _copyToClipboard } from '../../src/ui/MessageList';
import { checkPermission, createPermissionState } from '../../src/agent/permissions';
import type { ToolDefinition } from '../../src/tools/schemas/types';
import { loadModeForCwd, saveModeForCwd } from '../../src/config/mode-store';
import { loadProfile, saveProfile, listProfiles, applyProfile } from '../../src/config/profiles';
...
import { FileWatcher } from '../../src/watcher/index';
...
import { _planCacheCleanupInterval } from '../../src/agent/loop';
...
import { _parseContentCache, _parseContentForTesting } from '../../src/ui/MessageList';
...
describe('PERF-4b: UIMessage._precomputedSegments optional field', () => {
  ...
  it('UIMessage can be constructed without _precomputedSegments (backwards compat)', () => {
    ...
    const msg: import('../../src/ui/types').UIMessage = {
      id: 'test-1',
      role: 'user',
      content: 'hello',
      timestamp: new Date(),
